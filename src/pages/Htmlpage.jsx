  ...
  return (
    <div className='hero min-h-screen bg-base-200'>
      <div className="hero-content flex flex-col items-center max-w-3xl">
        <h3 className='text-4xl font-bold text-center hover:text-cyan-400'><a href='https://www.w3schools.com/html/' target='_blank'>HTML - Hyper Text Markup Language</a></h3>
